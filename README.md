...
```shell
  docker buildx build -t thatbeautifuldream/demo-docker-ext:latest . --load
```

To install the extension, use `make install-extension` **or**:

```shell
  docker extension install thatbeautifuldream/demo-docker-ext:latest
```
...
```shell
  docker extension dev ui-source thatbeautifuldream/demo-docker-ext:latest http://localhost:3000
```

In order to open the Chrome Dev Tools for your extension when you click on the extension tab, run:

```shell
  docker extension dev debug thatbeautifuldream/demo-docker-ext:latest
```

Each subsequent click on the extension tab will also open Chrome Dev Tools. To stop this behaviour, run:

```shell
  docker extension dev reset thatbeautifuldream/demo-docker-ext:latest
```
...
```shell
docker extension update thatbeautifuldream/demo-docker-ext:latest
```
...
```shell
docker extension rm thatbeautifuldream/demo-docker-ext:latest
```
